...
with open("README.md", "w") as f:
    ...
    f.write("```\n\n")
    f.write("## Note\n")
    f.write("Challenge 1 - options for operation are: add, subtract, multiply, divide.\n")
    f.write("Challenge 1 - from https://catalog.data.gov/dataset/lottery-mega-millions-winning-numbers-beginning-2002/resource/61eea3d0-6b6d-43a4-ae02-6432e6a4e517 and store the file in data_files directory")
    f.write("- Make sure you have internet connection to download the data for challenge 2,3\n")
    f.write("- Make sure you have internet connection to download the data for challenge 1\n")
